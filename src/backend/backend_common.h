...
bool build_shadow(xcb_connection_t *, xcb_drawable_t, double opacity, const uint16_t width,
                  const uint16_t height, const conv *kernel, xcb_render_picture_t shadow_pixel,
